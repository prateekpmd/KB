...
const Netlify = ({ setNoteQuantifier, noteQuantifier, listall, setListAll }) => {
  ...
  return (
    <>
      <form
        ...
        className="lg:text-sm xl:text-sm md:text-sm sm:text-sm border-t-2 mt-4  border-gray-300 pt-5 "
      >
